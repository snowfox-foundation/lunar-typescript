...
export class I18n {
  ...
  private static _MESSAGES: { [key: string]: { [key: string]: string } } = {
    ...
    vi: {
      ...
      "ps.bei": "Bắc",
      "ps.zhong": "Trung cung",
      "ps.zhengDong": "Chính Đông",
      "ps.zhengNan": "Chính Nam",
      "ps.zhengXi": "Chính Tây",
      "ps.zhengBei": "Chính Bắc",
      "jq.dongZhi": "Đông chí",
      "jq.xiaoHan": "Tiểu hàn",
      "jq.daHan": "Đại hàn",
      "jq.liChun": "Lập xuân",
      ...
      "jr.qiXi": "Lễ Thất Tịch",
      "jr.zhongQiu": "Tết Trung Thu",
      "jr.chongYang": "Tết Trùng Cửu",
      "jr.laBa": "Tết Lạp Bát",
      ...
      "jr.guoQing": "Quốc khánh",
      "jr.shengDan": "Giáng sinh",
    },
  };

  private static _OBJS: {
    [key: string]: LunarUtil | SolarUtil | TaoUtil | FotoUtil | NineStarUtil;
  } = {
    LunarUtil: LunarUtil,
    SolarUtil: SolarUtil,
    TaoUtil: TaoUtil,
